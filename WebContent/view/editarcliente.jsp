    ...
    <main>
        <form id="editarclienteForm">
            <div class="mb-3">
                ...
                <input type="text" name="runCliente" class="form-control" id="runCliente" value="${u.getRun()}">
            </div>
            <div class="mb-3">
                <label for="nombresCliente" class="form-label">Nombres</label>
                <input type="text" name="nombresCliente" class="form-control" id="nombresCliente" value="${u.getNombre()}">
            </div>
            <div class="mb-3">
                <label for="apellidosCliente" class="form-label">Apellidos</label>
                <input type="text" name="apellidosCliente" class="form-control" id="apellidosCliente" value="${u.getApellidos()}">
            </div>
            <div class="mb-3">
                <label for="telefonoCliente" class="form-label">Telefono</label>
                <input type="tel" name="telefonoCliente" class="form-control" id="telefonoCliente" value="${u.getTelefono()}">
            </div>
            <div class="mb-3">
                <label for="afp" class="form-label">AFP</label>
                <input type="text" name="afp" class="form-control" id="afp" value="${u.getAfp()}">
            </div>
            <div class="mb-3">
                <label for="select" class="form-label">Sistema de salud</label>       
                <select class="form-select" name="sistemadesalud" id="sistemadesalud" aria-label="select" value="${u.getSistemaSalud()}" >
            ...
            <div class="mb-3">
                ...
                <input type="text" name="direccion" class="form-control" id="direccion" value="${u.getDireccion()}">
            </div>
            <div class="mb-3">
                <label for="comuna" class="form-label">Comuna</label>
                <input type="text" name="comuna" class="form-control" id="comuna" value="${u.getComuna()}">
            </div>
            <div class="mb-3">
                <label for="edad" class="form-label">Edad</label>
                <input type="number" name="edad" class="form-control" id="edad" value="${u.getEdad()}">
            </div>
            <div class="mb-3">
